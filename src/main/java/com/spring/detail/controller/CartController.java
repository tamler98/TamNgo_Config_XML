...
//    public String saveCarts(@PathVariable Integer id,RedirectAttributes redirectAttributes) {
...
//        redirectAttributes.addFlashAttribute("message", "Add new cart successfully!");
...
//    public String delCart(@PathVariable Integer id, RedirectAttributes redirectAttributes) {
//        redirectAttributes.addFlashAttribute("message", "Remove cart successfully!");
...
//        redirectAttributes.addFlashAttribute("message", "Form data saved successfully!");
//        return "redirect:/cart";
//    }
